        ...
        <div className="bg-gradient-to-r from-[#148ca0] to-[#0f1c54] py-16">
            <div className="container">
                <div className="lg:px-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-9 gap-y-8 lg:gap-x-[72px] lg:gap-y-[60px] ">
                        {
                            posts?.map((post) =>
                            (
                                <div className="p-8 bg-white">
                                    <h3 className="t-18 text-dark-blue font-rubik font-medium pb-5 relative
