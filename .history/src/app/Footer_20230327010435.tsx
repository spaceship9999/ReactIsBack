            ...
            <div className="container font-rubik">
                <div className="flex flex-col xl:flex-row gap-y-20 items-center t-18 xl:gap-x-20">
                    ...
                    <div className="w-[90%] xl:w-full xl:flex-auto flex flex-col lg:flex-row space-y-8 justify-between">
                        ...
                        <div>
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-7 tracking-wider">Our partners</h4>
                            <ul className="text-white font-rubik t-14 space-y-1">
                                <li>
                        ...
                        <div>
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-7 tracking-wider">Work with us</h4>
                            <ul className="text-white font-rubik t-14 space-y-1">
                                <li>
