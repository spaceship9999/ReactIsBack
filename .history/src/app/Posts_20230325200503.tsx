        ...
        <div className="bg-gradient-to-r from-[#148ca0] to-[#0f1c54] py-16">
            <div className="container">
                <div className="lg:px-10">
                    <h2 className="text-white t-48 font-montserrat font-bold lg:pb-10 relative leading-none
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-[72px] gap-y-8">
                        {
                            ...
                            (
                                <div className="p-8 bg-white">
                                    <h3 className="t-18 text-dark-blue font-rubik font-medium mb-5">{post?.title}</h3>
