                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-9 gap-y-8 xl:gap-x-[72px] xl:gap-y-[60px] ">
                        {
                            ...
                            (
                                <div key={post?.id} className="flex flex-col justify-between p-8 bg-white font-rubik">
                                    <div>
                                        <h3 className="t-18 text-dark-blue font-medium pb-4 relative leading-[1.2]
                                    ...
                                    <div>
                                        <a className="inline-block bg-light-green text-white t-14 rounded-full px-4 py-2 font-bold tracking-tight" href={`/post/${post?.id}`}>
