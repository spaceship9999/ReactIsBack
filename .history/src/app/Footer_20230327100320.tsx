    ...
    return (
        <footer className="bg-dark-blue pt-[78px] pb-[60px]">
            <div className="container font-rubik">
                <div className="flex flex-col xl:flex-row gap-y-20 items-center xl:items-start t-18 xl:gap-x-20">
                    <div className="flex flex-col items-center text-white lg:w-[210px] xl:items-start">
                        <Logo className="w-[113px] mb-8 xl:mb-14"/>
                        <address className="not-italic  text-center xl:text-start leading-[1.5] mb-4">
                    ...
                    <div className="w-[90%] xl:w-full xl:flex-auto flex flex-col lg:flex-row gap-y-8 justify-between">
                        <div className="text-center lg:text-start">
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-4 lg:mb-7 tracking-wider">Who we are</h4>
                        ...
                        <div className="text-center lg:text-start">
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-4 lg:mb-7 tracking-wider">What we do</h4>
                            <ul className="text-white font-rubik t-14 space-y-1">
                                <li>
                                    <a href="/">What we do</a>
                                </li>
                        ...
                        <div className="text-center lg:text-start">
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-4 lg:mb-7 tracking-wider">Our partners</h4>
                            <ul className="text-white font-rubik t-14 space-y-1">
                                <li>
                                ...
                                <li>
                                    <a href="/">Vendor partners</a>
                                </li>
                                <li>
                                    <a href="/">Global partner management</a>
                                </li>
                                <li>
                                    <a href="/">Partner selection</a>
                                </li>
                                <li>
                        ...
                        <div className="text-center lg:text-start">
                            <h4 className="font-montserrat text-[#26ab99] font-semibold mb-4 lg:mb-7 tracking-wider">Work with us</h4>
                            <ul className="text-white font-rubik t-14 space-y-1">
                                <li>
