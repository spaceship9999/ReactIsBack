        ...
        <div className="bg-gradient-to-r from-[#148ca0] to-[#0f1c54] py-16">
            <div className="container">
                <div className="lg:px-10">
                    ...
                    <div className="pt-14 flex gap-1 font-montserrat">
                        <button className="rounded-full flex justify-center items-center bg-white text-dark-blue w-8 h-8 font-bold">1</button>
                        <button className="rounded-full flex justify-center items-center bg-white text-grey w-8 h-8 font-bold">2</button>
                        <button className="rounded-full flex justify-center items-center bg-white text-grey w-8 h-8 font-bold">3</button>
                    </div>
                </div>
