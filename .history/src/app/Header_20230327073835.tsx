    ...
    return (
        <div className="container py-5 relative">
            <div className="flex justify-between items-center">
                ...
                <button className="p-4" onClick={() => setIsMenuOpened(!isMenuOpened)}>
                    <MenuIcon/>
                </button>
            ...
            <nav className={`${!isMenuOpened ? 'hidden' : 'fixed right-0 inset-y-0 w-[250px] flex flex-col z-20 pt-24 px-4'} xl:hidden gap-7 font-montserrat font-medium text-grey bg-white`}>
                <Link href="/who-we-are" >
                    Who we are
                </Link>
                <Link href="/what-we-do" >
                ...
                <button className="flex items-center gap-x-1">
                    <img src="/img/gb-flag.png" className="w-3" />
                    English
                </button>
                <button>
                    <Search />
            ...
            <a href="#" onClick={() => setIsMenuOpened(!isMenuOpened)} className={`${!isMenuOpened ? 'hidden' : `block`} fixed inset-0 bg-black/70 z-[15]`}></a>
        </div>
    )
}
