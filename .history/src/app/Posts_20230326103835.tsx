                            ...
                            (
                                <div key={post?.id} className="flex flex-col justify-between p-8 bg-white font-rubik">
                                    <div>
                                        ...
                                        <div className="pt-4 t-14 leading-[1.1] text-dark-blue mb-6">
                                            {post?.body}
                                        </div>
                                    </div>
                                    <div>
                                        <a className="inline-block bg-light-green text-white t-14 rounded-full px-4 py-2 font-semibold tracking-tight" href={`/post/${post?.id}`}>
