    ...
    return (
        <footer className="bg-dark-blue pt-[78px] pb-[60px]">
            <div className="container font-rubik">
                <div className="flex flex-col xl:flex-row gap-y-20 items-center t-18 xl:gap-x-20">
                    ...
                    <div className="w-[90%] xl:w-full xl:flex-auto flex flex-col lg:flex-row space-y-8 justify-between">
                        <div>
