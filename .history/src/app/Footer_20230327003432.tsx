export default function Footer() {
    return (
        <footer className="bg-dark-blue py-[78px]">
            <div className="container">
                <div className="flex t-18">
                    <div className="w-[206px] text-white">
                        <Logo className="w-[113px] mb-14"/>
                        <address className="not-italic font-rubik leading-[1.8] mb-4">
                            NSC Global Limited<br/>
                            3rd Floor, West Building<br />
                            1 London Bridge London<br />
                            SE1 9BG
                        </address>
                        <a className="block mb-4" href="tel:+442078086300">+44 20 7808 6300</a>
                        <a className="block mb-4" href="mailto:enquiries@nscglobal.com">enquiries@nscglobal.com</a>
                    </div>
                </div>
            </div>
        </footer>
