...
export default function Header() {
    ...
    return (
        <div className="container py-5 relative">
            ...
            <nav className={`${!isMenuOpened ? 'hidden' : 'fixed right-0 inset-y-0 w-[250px] flex flex-col z-20 pt-24'} xl:hidden gap-7 font-montserrat font-medium text-grey bg-white`}>
                <Link href="/who-we-are" >
                    Who we are
                </Link>
                <Link href="/what-we-do" >
